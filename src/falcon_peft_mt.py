...
dataset = load_dataset('json', data_files={'train': script_args.dataset_name}) # CHANGED

def formatting_prompts_func(example):
    output_text = f"English: <s>{example['eng']}</s>\nSpanish: <s>{example['spa']}</s>"
    return output_text

response_template = "Spanish: <s>"
